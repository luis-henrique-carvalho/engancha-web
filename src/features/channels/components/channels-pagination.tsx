...
import { AutomationActivityPageButtons } from '@/features/automations/components/activity/automation-activity-page-buttons'
...
export function ChannelsPagination({
  ...
  return (
    <div
      ...
      data-testid="channels-pagination"
    >
      <div className="flex w-full items-center justify-between">
        <div className="flex w-25 items-center justify-center text-xs font-medium text-muted-foreground @2xl/content:hidden">
          Página {currentPage} de {safeTotalPages} ({total} {total === 1 ? 'canal' : 'canais'})
        </div>
        ...
        <div className="flex items-center gap-2 @max-2xl/content:flex-row-reverse">
          ...
          >
            <SelectTrigger
              ...
              data-testid="channels-page-size-trigger"
            >
